...
<body>
<div>  <!-- class="container" --> 
 <div class="well well-sm">Households</div> 
                ...
                <div class="card acik-renk-form">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group "> 
                                <span style="color:red;font-weight: bolder;">STATUS</span>
								 
                                     <select name="status" id="status-list" class="form-control" disabled>
...
<!--                     <th colspan="3"  class="text-center">Panel</th> -->
<!--                     <th colspan="4"  class="text-center">Installation Calls</th> -->
...
//                  "filename": "Households Excel",
//                  "className": "btn btn-warning",
//                  "charset": "utf-8",
//                  "bom": "true",
//                  "title":"Households Panel",
...
//     	    }],
        ...
        "serverSide": true,
        "ajax": {
            url: "http://tam.statleb.com:6700/devices", 
            //data: {action: 'getHouseholdData',mohafazaId : mohafazaId, qadaaId : qadaaId, regionId : regionId, statusId : statusId , ratioId : ratioId, userId: userId, searchDate:searchDate},
            type: 'get',  
        },
