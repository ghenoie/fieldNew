...
<body>
<div>  <!-- class="container" --> 
<div class="well well-sm">Summary Report</div>
...
{ 
    ...
    var dataTable = $('#quota-grid').DataTable({
        ...
        "ajax": {
            ...
            data: {action: 'getQuotaData',mohafazaId : mohafazaId, qadaaId : qadaaId, regionId : regionId, statusId : statusId , userId: userId, searchDate:searchDate},
