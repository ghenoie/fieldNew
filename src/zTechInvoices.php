...
<body>
<div>  <!-- class="container" --> 
 <div class="well well-sm">Technician Invoices</div> 
							...
							<div class="col-md-4">
                               <div class="form-group ">
									 <select name="amount" id="amount-list" class="form-control">
									 		...
									 		<option value="202104">#16 - April 2021</option>
        ...
        <table id="quota-grid" class="table dataTable table-striped table-bordered" style="width:100%">
             <thead>
                <tr>
                    ...
                    <th colspan="3"  class="text-center">Installation Cost</th>
                     <th colspan="2"  class="text-center">Incentives</th>
...
//   	  ],
         buttons: [ 
             ...
             $.extend( true, {}, buttonCommon, {
                 ...
                 "filename": "Technician_Invoice",
                 "className": "btn btn-warning",
                 "charset": "utf-8",
                 "bom": "true",
                 "title":"Technician Invoice",
