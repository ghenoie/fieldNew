                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                     ...
                                     <select name="ratio" id="ratio-list" class="form-control">
                                       <option value="999">Not Specified</option>
                                       <option value="0">Less than Target </option>
									   <option value="1">Equal Target Reached</option>
									   <option value="2">Double Target Reached</option>
									   <option value="3">Triple Target Reached</option>
									 </select>
...
//     	    }],
		...
		// Update footer by showing the total with the reference of the column index .
          ...
          $( api.column( 5 ).footer() ).html(numFormat(quotaPercent)	);
        ...
        "ajax": {
            url: "getServices.php", 
            data: {action: 'getPanelData',mohafazaId : mohafazaId, qadaaId : qadaaId, regionId : regionId, statusId : statusId , ratioId : ratioId, userId: userId, searchDate:searchDate},
            type: 'post',  
        },
